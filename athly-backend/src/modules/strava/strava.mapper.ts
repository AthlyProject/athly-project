...
export function mapStravaSportType(activity: StravaRawActivity): SportType {
...
export function deriveIntensity(activity: StravaRawActivity): number {
...
export function buildStravaWorkoutBlock(activity: StravaRawActivity) {
